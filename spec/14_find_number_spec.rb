...
describe FindNumber do
  ...
  describe '#make_guess' do
    ...
    context 'when min and max both equal 3' do
      subject(:game_equal) { described_class.new(3, 3, number_guessing) }
      it 'returns 3' do
        guess= game_equal.make_guess
  ...
  describe '#game_over?' do
    context 'when guess and random_number are equal' do
      ...
      let(:random_number) { double('random_number', value: 3) }  #called at the end
      subject(:game_end) {described_class.new(0, 9, random_number, 3)}
    ...
    context 'when guess and random_number are not equal' do
      let(:random_number) { double('random_number', value: 3) }
      subject(:game_end) {described_class.new(0, 9, random_number, 5)}
