...
describe NumberGame do
  ...
  describe '#initialize' do
    context 'when solution is initialized' do
      ...
      it 'is a number between 0 and 9' do
        ...
        expect(result).to be_between_zero_and_nine
      end
    end
  end
  ...
  describe '#game_over?' do
    ...
    context 'when user guess is not correct' do
      subject(:user_choice) {described_class.new(5, '2')}
      # remove the 'x' before running this test
      it 'is not game over' do
        expect(user_choice).to_not be_game_over
      end
    end
  end
  ...
  describe '#player_turn' do
    ...
    context 'when user inputs two incorrect values, then a valid input' do
      before do
        ...
        second_letter= 'x'
        third_letter= '8'
        allow(game_loop).to receive(:player_input).and_return(first_letter, second_letter, third_letter)
      end
  ...
  describe '#final_message' do
    ...
    context 'when count is 4 and over' do
      ...
      it 'outputs correct phrase' do
        ...
        expect{game_five.final_message}.to output(phrase).to_stdout
      end
    end
  end
end
